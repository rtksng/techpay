...
export const metadata: Metadata = {
  title: "Terms and Conditions | TechPay.ai",
  description: "Terms and Conditions for TechPay.ai in India and Malaysia.",
};
...
export default function TermsAndConditionsPage() {
  return (
    <main className="min-h-screen bg-techpay-bg px-5 pb-20 pt-32 text-techpay-text md:px-10 md:pb-28 md:pt-40 lg:px-[60px]">
      <MarketPolicyTabs
        ariaLabel="Terms and conditions country"
        panelIdPrefix="terms-and-conditions"
        india={<LegalPolicyDocument policy={indiaTermsPolicy} />}
        malaysia={<LegalPolicyDocument policy={malaysiaTermsPolicy} />}
      />
    </main>
  );
}
