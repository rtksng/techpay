...
const benefitWavePoints = [
  { left: "6%", top: "20%", labelPlacement: "bottom" },
  { left: "26%", top: "-15%", labelPlacement: "top" },
  { left: "48%", top: "20%", labelPlacement: "bottom" },
  { left: "70%", top: "-15%", labelPlacement: "top" },
  { left: "92%", top: "20%", labelPlacement: "bottom" },
] as const;

const WAVE_PATH =
  "M20 150 C 100 210, 170 210, 240 150 S 380 90, 460 150 S 600 210, 680 150 S 820 90, 900 150 S 1040 210, 1170 150";

const LINE_DRAW_DURATION_MS = 1700;
const POINT_REVEAL_PROGRESS = [0.05, 0.25, 0.47, 0.68, 0.90];
const POINT_REVEAL_DELAYS_MS = POINT_REVEAL_PROGRESS.map((progress) =>
  Math.round(LINE_DRAW_DURATION_MS * progress)
);

export default function OemBenefitsTimeline() {
        ...
        <div className="absolute inset-x-0 top-1/2 -translate-y-1/2">
          ...
          >
            ...
            <path
              ...
              pathLength={1}
              fill="none"
              stroke="url(#oem-benefit-wave-gradient)"
              strokeWidth="8"
              strokeLinecap="round"
